                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"
                            action="{{ route('products.update',$product->id) }}" method="POST" id="productForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Death Day"
                                        name="date_death" value="{{ $product->date_death }}">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Birth Day G"
                                        name="date_birthday_g" value="{{ $product->date_birthday_g }}">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Death Day G"
                                        name="date_death_g" value="{{ $product->date_death_g }}">
                                ...
                                <div class="col-md-3 col-sm-3 ">
                                    ...
                                    {{-- @dd($product->image_visible); --}}
                                    <select class="form-control" name="image_visible">
                                        <option {{ $product->image_visible == "0" ? 'selected' : '' }} value="0">Hidden
                                        </option>
                                        <option {{ $product->image_visible == "1" ? 'selected' : '' }} value="1">Visible
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-3 col-sm-3 ">
                                    ...
                                    <select class="form-control" name="api_featured">
                                        <option {{ $product->api_featured == "0" ? 'selected' : '' }} value="0">No
                                        </option>
                                        <option {{ $product->api_featured == "1" ? 'selected' : '' }} value="1">Yes
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-3 col-sm-3 ">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        <option {{ $product->status == "0" ? 'selected' : '' }} value="0">Deactive
                                        </option>
                                    </select>
                                    @error('status')
                                    <span class="invalid-feedback" role="alert">
        ...
        $(document).ready(function() {
            $.ajax({
                ...
                success: function(result) {
                    ...
                    }).val({{ $product->type_id }}).trigger("change");
                }
            });
