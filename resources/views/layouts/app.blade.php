...
<head>
    ...
    <link rel="icon" type="image/ico" href="{{ config('global.siteURL') }}{{ config('global.imgLogin') }}/favicon.ico"/>
    ...
    <meta name="developer" content="Ali Raza">
</head>
