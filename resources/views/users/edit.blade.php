        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form class="form-horizontal form-label-left" action="{{ route('users.update', $user->id) }}"
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12 col-sm-12">
                                        <label class="control-label fs18">Name </label>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <label class="control-label fs18">Username </label>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <label class="control-label fs18">Email </label>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <label class="control-label fs18">Password </label>
                                        <input type="password" class="form-control" placeholder="Password" id="password"
                                            name="password" value="">
                                        <span>Leave empty if you don't change password</span>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <select class="form-control" id="role" name="role">
                                            ...
                                            <option {{ $user->role == 'viewer' ? 'selected' : '' }} value="viewer">Viewer</option>
                                            <option {{ $user->role == 'subscriber' ? 'selected' : '' }} value="subscriber">Subscriber</option>
                                        </select>
